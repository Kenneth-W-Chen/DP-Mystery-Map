...
namespace PlayerInfo
{
    public static class StageData
    {
        ...
        public static readonly ReadOnlyCollection<PlayerPosition> FloorOneToFloorTwoPos =
            new ReadOnlyCollection<PlayerPosition>(new List<PlayerPosition>()
            {
        ...
        public static readonly ReadOnlyCollection<PlayerPosition> FloorTwoToFloorOnePos =
            new ReadOnlyCollection<PlayerPosition>(new List<PlayerPosition>()
            {
